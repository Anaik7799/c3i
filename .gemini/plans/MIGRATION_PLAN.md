...
- [ ] 1.1.2.1 - Property-based tests for metabolic scaling algorithms.
- [ ] 1.1.2.2 - Zenoh telemetry verification (OODA Loop integration).

### 1.2 - KMS Catalog & Safety (Key Management)
#### 1.2.1 - Port `KmsCatalog.fs` Logic
- [ ] 1.2.1.1 - Implement Gleam `KmsCatalog` actor for key lifecycle management.
- [ ] 1.2.1.2 - Integrate with `Indrajaal.Native.Zenoh` for secure key distribution.
#### 1.2.2 - Verify Safety Kernel Invariants
- [ ] 1.2.2.1 - Unit tests for key rotation and revocation logic.
- [ ] 1.2.2.2 - Formal verification of SC-SEC-001 (Zero-Trust Key Management).
...
*Total Tasks: 124 | Completed: 57 | Progress: 46.0%*

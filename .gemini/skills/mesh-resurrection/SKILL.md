...
- **AOR-RES-PLAN**: ALL tasks related to resurrection MUST be tracked via `sa-plan`, which resolves to the Rust binary `./sub-projects/c3i/target/release/sa-plan-daemon`.

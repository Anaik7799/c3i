...
Rust planning_daemon orchestrates 16-container SIL-6 Biomorphic Mesh + 6-tier chat inference + 5-tier voice cascade.
**Rust binary**: `sub-projects/c3i/native/planning_daemon/src/main.rs` (entry point)
**Rust modules**: 31 files, 9,104 LOC — cortex, inference, gateway, trace, ruliology, voice, RAG, PII, FMEA, HA election

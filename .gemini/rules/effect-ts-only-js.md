...
This browser/IIFE rule is paired with the 2026-05-09 universal TypeScript mandate in `.gemini/rules/effect-ts-universal.md`. All generated or modified TypeScript must use Effect, not `fp-ts`.
...
- `.gemini/rules/effect-ts-universal.md` (SC-EFFECT-TS-008..020) — all TypeScript

...
Operator directive 2026-04-30 — *"all javascript code MUST ONLY use effect typescript, full IIFE collapse"*. Operator directive 2026-05-09 extends this: all generated or modified TypeScript MUST use Effect and MUST NOT introduce `fp-ts`. This agent reviews diffs and refuses non-compliant browser JS.
...
- Any browser-reachable TypeScript that does not import from `effect` / `@effect/*`

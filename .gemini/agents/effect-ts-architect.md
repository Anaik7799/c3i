...
- Cite `.gemini/rules/effect-ts-universal.md` for general TS.
- Cite `.gemini/rules/effect-ts-only-js.md` for browser/runtime JS and IIFE bundles.
...
Return compliance verdict, violated SC-EFFECT-TS IDs, concrete patch guidance, and validation commands run or still required.

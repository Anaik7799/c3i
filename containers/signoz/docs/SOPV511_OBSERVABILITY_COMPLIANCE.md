...
defmodule Indrajaal.Observability.HealthMonitor do
  use GenServer
...
Indrajaal.Observability.AuditLogger.log_operation(
  "container_start",
  %{
...
```elixir
defmodule Indrajaal.Observability.Jidoka do
...
elixir -e "Indrajaal.Observability.AuditLogger.log_operation(
  'deployment_start',
  %{script: 'start-signoz-simple.sh'}
)"
...
```elixir
defmodule Indrajaal.Observability.EmergencyResponse do
...
```elixir
defmodule Indrajaal.Observability.ComplianceMonitor do

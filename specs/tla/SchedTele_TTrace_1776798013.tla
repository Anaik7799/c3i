---- MODULE SchedTele_TTrace_1776798013 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SchedTele_TTrace_1776798013.json", _TETrace)
...
\*
\*trace == IODeserialize("SchedTele_TTrace_1776798013.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SchedTele_TTrace_1776798013 ----
CONSTANTS
    MaxJobs = 2
    MaxAttempts = 2
    TelemetryBufCap = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Apr 21 21:00:59 CEST 2026
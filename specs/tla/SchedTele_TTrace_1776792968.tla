---- MODULE SchedTele_TTrace_1776792968 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SchedTele_TTrace_1776792968.json", _TETrace)
...
\*
\*trace == IODeserialize("SchedTele_TTrace_1776792968.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 1,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 2,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 3,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 4,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 5,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 6,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 7,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 8,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 9,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>]),
    ([run_id |-> <<1, 0>>,proc_state |-> <<"running", "idle">>,tele_dropped |-> 0,proc_started_at |-> <<0, 0>>,zenoh_up |-> TRUE,tele_buf |-> <<1>>,clock |-> 10,job_state |-> <<"executing", "available">>,attempt |-> <<1, 0>>])
    >>
----
...
---- CONFIG SchedTele_TTrace_1776792968 ----
CONSTANTS
    MaxJobs = 2
    MaxAttempts = 2
    TelemetryBufCap = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Apr 21 19:36:20 CEST 2026
---- MODULE SchedTele_TTrace_1776798516 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SchedTele_TTrace_1776798516.json", _TETrace)
...
\*
\*trace == IODeserialize("SchedTele_TTrace_1776798516.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SchedTele_TTrace_1776798516 ----
CONSTANTS
    MaxJobs = 2
    MaxAttempts = 1
    TelemetryBufCap = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Apr 21 21:10:11 CEST 2026
...
| Page-spec checker for `/planning` (`required_substrings = ["all-grid","blocked-grid","active-grid","planning-grid.js","task-detail-panel"]`) — alignment must equal `5/5` | SC-PAGE-SPEC-001..008 | `gleam run -m scripts/verify/page_checker` |

defmodule AlarmAshIntegrationDemoTest do
  ...
  @moduledoc """
  TDG - Compliant Test Suite for Alarm Ash Integration Demo
  ...
  describe "Alarm Ash Integration Demo Execution" do
    test "demo script exists and is executable" do
      demo_script_path = "scripts/demo/alarm_ash_integration_demo.exs"

      assert File.exists?(demo_script_path),
             "Demo script must exist at #{demo_script_path}"

      # Check for executable permission (approximate check for linux/mac)
      # stat.mode & 0o111 != 0
    ...
    test "demo script compiles without errors" do
      assert Code.compile_file("scripts/demo/alarm_ash_integration_demo.exs")
    end
  ...
  describe "Enterprise Demo Workflow Testing" do
    ...
    test "demo validates business rules" do
      ...
      # Email might be generated or nil depending on factory, checking struct validity

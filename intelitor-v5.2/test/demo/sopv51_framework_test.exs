defmodule Sopv51FrameworkTest do
  ...
  @moduledoc """
  TDG - Compliant Test Suite for Sopv51 Framework
  ...
  describe "Sopv51 Framework Execution" do
    test "demo script exists and is executable" do
      demo_script_path = "scripts/demo/sopv51_framework.exs"
    ...
    test "demo script compiles without errors" do
      assert Code.compile_file("scripts/demo/sopv51_framework.exs")
    end

defmodule Indrajaal.SOPv511ObservabilityComplianceTest do
  @moduledoc """
  ...
  alias Indrajaal.Observability.{HealthMonitor, AuditLogger, Jidoka}

  setup do
    # Setup test environment
    Application.put_env(:indrajaal, :test_mode, true)

    on_exit(fn ->
      Application.delete_env(:indrajaal, :test_mode)
    end)

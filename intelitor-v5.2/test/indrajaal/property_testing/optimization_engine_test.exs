defmodule Indrajaal.PropertyTesting.OptimizationEngineTest do
  use ExUnit.Case, async: true

  @moduletag :zenoh_nif

  # NOTE: Indrajaal.PropertyTesting.OptimizationEngine is currently a disabled stub.
  ...
  @module_name Indrajaal.PropertyTesting.OptimizationEngine
  ...
  test "stub source file exists at expected path" do
    path = "lib/indrajaal/property_testing/optimization_engine.ex"

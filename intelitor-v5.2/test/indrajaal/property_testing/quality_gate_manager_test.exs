defmodule Indrajaal.PropertyTesting.QualityGateManagerTest do
  use ExUnit.Case, async: true

  @moduletag :zenoh_nif

  # NOTE: Indrajaal.PropertyTesting.QualityGateManager is currently a disabled stub.
  ...
  @module_name Indrajaal.PropertyTesting.QualityGateManager
  ...
  test "stub source file exists at expected path" do
    path = "lib/indrajaal/property_testing/quality_gate_manager.ex"

...
# SOPv5.1 ENHANCED SCRIPT - fix_list_functions.exs
...
# Fix list_*! function calls to use correct Ash patterns
...
defmodule FixListFunctions do
  
__require Logger

@moduledoc """
  Fixes tests that use Core.list_*! functions to use Resource.list! instead.
  ...
  - Core.get_feature_flag_by_name! → FeatureFlag.get_by_name!
  """
...
**Agent**: Script Enhancement System with systematic SOPv5.1 integration
  ...
  defp fix_test_file(file_path) do
    if File.exists?(file_path) do
      ...
      |> String.replace("Core.get_feature_flag_by_name!", "FeatureFlag.get_by_name!")

      if original != fixed_content do
        File.write!(file_path, fixed_content)
        IO.puts("    ✓ Fixed list functions")
      end
    end
  end
end

FixListFunctions.run()

defmodule Intelitor.Maintenance.ServiceRecord do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :technician, Intelitor.Accounts.User do
      attribute_public? true
    end

    belongs_to :supervisor, Intelitor.Accounts.User do
      attribute_public? true
    end

    belongs_to :created_by_user, Intelitor.Accounts.User do
  ...
  actions do
    ...
    create :create do
      ...
      change fn changeset, _context ->
        ...
        labor_cost = Ash.Changeset.get_argument_or_attribute(changeset, :labor_cost) || 0.0
        parts_cost = Ash.Changeset.get_argument_or_attribute(changeset, :parts_cost) || 0.0

        materials_cost =
          Ash.Changeset.get_argument_or_attribute(changeset, :materials_cost) || 0.0

        external_cost = Ash.Changeset.get_argument_or_attribute(changeset, :external_cost) || 0.0
        travel_cost = Ash.Changeset.get_argument_or_attribute(changeset, :travel_cost) || 0.0
        overhead_cost = Ash.Changeset.get_argument_or_attribute(changeset, :overhead_cost) || 0.0

        total_cost =
          labor_cost + parts_cost + materials_cost + external_cost + travel_cost + overhead_cost
    ...
    update :add_reading do
      ...
      change fn changeset, _context ->
        readings = Ash.Changeset.get_attribute(changeset, :post_service_readings) || []
    ...
    update :record_inspection do
      ...
      change fn changeset, _context ->
        ...
        |> Ash.Changeset.force_change_attribute(
          :inspection_passed?,
          changeset.arguments.passed?
        )
        |> Ash.Changeset.force_change_attribute(
          :inspector_name,
          changeset.arguments.inspector
        )
    ...
    update :calculate_total_cost do
      ...
      change fn changeset, _context ->
        ...
        materials = Ash.Changeset.get_attribute(changeset, :materials_cost) || 0.0
  ...
  defp generate_record_number(changeset) do
    # Generate record number like SR-20251206-001

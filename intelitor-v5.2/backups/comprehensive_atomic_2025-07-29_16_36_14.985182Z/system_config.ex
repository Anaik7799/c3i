defmodule Intelitor.Core.SystemConfig do
  @moduledoc """
    ...
    create :set do
      ...
      change fn changeset, _ ->
        if Ash.Changeset.get_attribute(changeset, :encrypted?) do
          ...
          encrypted = %{encrypted: true, data: Base.encode64(Jason.encode!(value))}
  ...
  calculations do
    ...
    calculate :safe_value, :map do
      ...
      description "Value with encrypted data hidden"
    end
  end
  ...
  defmodule Helpers do
    ...
    def get_config(key, tenant_id, actor) do
      case Intelitor.Core.SystemConfig.get(
    ...
    def set_config(key, value, _tenant_id, actor, opts \\ []) do
      params = %{
        key: key,
        value: value,
      ...
      Intelitor.Core.SystemConfig.set(params, actor: actor)
    end
  end
end

defmodule Intelitor.Analytics.SecurityDashboard do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :team, Intelitor.Accounts.Team
    belongs_to :organization, Intelitor.Core.Organization
  end

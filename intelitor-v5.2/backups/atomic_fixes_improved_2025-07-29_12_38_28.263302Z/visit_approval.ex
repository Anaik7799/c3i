defmodule Intelitor.VisitorManagement.VisitApproval do
  @moduledoc """
  Multi-level approval workflows for visit requests with delegation support.
  """
  ...
  relationships do
    ...
    belongs_to :delegated_to, Intelitor.Accounts.User do
      attribute_writable? true
    end

    belongs_to :escalated_to, Intelitor.Accounts.User do
      attribute_writable? true
    end
  end
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:tenant_id, :response_deadline], where: "response_deadline IS NOT NULL"

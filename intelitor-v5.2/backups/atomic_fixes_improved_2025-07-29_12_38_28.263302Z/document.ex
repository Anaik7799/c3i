defmodule Intelitor.Compliance.Document do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :report, Intelitor.Compliance.Report do
      attribute_public? true
    end

    belongs_to :parent_document, Intelitor.Compliance.Document do
      attribute_public? true
    end

    belongs_to :superseded_by_document, Intelitor.Compliance.Document do
      attribute_public? true
    end
    ...
    belongs_to :owner, Intelitor.Accounts.User do
      attribute_public? true
    end

    belongs_to :custodian, Intelitor.Accounts.User do
      attribute_public? true
    end
    ...
    has_many :child_documents, Intelitor.Compliance.Document do
      source_attribute :id
  ...
  actions do
    ...
    create :create do
      ...
      change fn changeset, _context ->
        ...
        |> (fn cs ->
              if next_review do
                Ash.Changeset.force_change_attribute(cs, :next_review_date, next_review)
              else
                cs
              end
            end).()
  ...
  policies do
    ...
    policy action(:read) do
      ...
      # Authorized users can read documents
  ...
  defp generate_document_number(changeset) do
    # Generate document number like DOC-20251206-001
    ...
    document_number = "DOC-#{date_str}-#{random_suffix}"

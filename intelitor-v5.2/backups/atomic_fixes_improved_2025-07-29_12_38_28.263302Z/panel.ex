defmodule Intelitor.Devices.Panel do
  ...
  relationships do
    ...
    # has_many :zones, Intelitor.Alarms.Zone
    # has_many :panel_users, Intelitor.Alarms.PanelUser
    # has_many :events, Intelitor.Alarms.Event
  end
  ...
  calculations do
    calculate :active_zones, :integer do
      # TODO: Calculate from related zones
    ...
    calculate :active_users, :integer do
      # TODO: Calculate from related panel users
      calculation fn _records, _context ->
        {:ok, 0}
      end
    end

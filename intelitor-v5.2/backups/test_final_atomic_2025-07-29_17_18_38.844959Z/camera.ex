defmodule Intelitor.Devices.Camera do
  @moduledoc """
  ...
  relationships do
    ...
    # TODO: Uncomment when Video domain is implemented
    # has_many :recordings, Intelitor.Video.Recording do
    #   public? true
    # end

    # has_many :snapshots, Intelitor.Video.Snapshot do
    #   public? true
    # end
  end
  ...
  actions do
    ...
    update :save_preset do
      ...
      change fn changeset, _context ->
        ...
        current_pos = Ash.Changeset.get_attribute(changeset, :current_position) || %{}
        presets = Ash.Changeset.get_attribute(changeset, :presets) || []
    ...
    calculate :motion_events_today, :integer do
      calculation fn records, _opts ->
        Enum.map(records, fn camera ->
          ...
          events = Map.get(metadata, "motion_events", [])
  ...
  validations do
    ...
    validate fn changeset, _context ->
      camera_type = Ash.Changeset.get_attribute(changeset, :camera_type)
      ptz_capabilities = Ash.Changeset.get_attribute(changeset, :ptz_capabilities)

      if camera_type == :ptz && (is_nil(ptz_capabilities) || ptz_capabilities == %{}) do

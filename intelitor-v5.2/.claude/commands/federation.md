...
allowed-tools: mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__zenoh_query, mcp__sentinel-zenoh__zenoh_sub, mcp__sentinel-zenoh__zenoh_pub, Read, Grep, Glob
argument-hint: [status|peers|attest|negotiate|topology]
---

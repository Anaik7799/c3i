---
description: Immutable Register & Unified Checkpoint Registry — append-only blocks, hash chains, Merkle proofs
allowed-tools: mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__checkpoint_op, mcp__sentinel-zenoh__zenoh_query, Read, Grep, Glob
argument-hint: [verify|append|chain|merkle|export|integrity]
---

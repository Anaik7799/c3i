---
description: Validate STAMP safety constraints for a file or module with live Zenoh/Sentinel verification
allowed-tools: Read, Grep, Glob, mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__zenoh_query

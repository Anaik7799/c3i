...
allowed-tools: mcp__sentinel-zenoh__checkpoint_op, mcp__sentinel-zenoh__multiverse_op, mcp__sentinel-zenoh__sentinel, Read, Grep
argument-hint: [capture|verify|fork|promote|prune|list] [name]
---

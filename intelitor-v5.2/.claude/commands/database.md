---
description: Database operations — holon naming, local/cross-holon access, migrations, PostgreSQL business data
allowed-tools: mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__zenoh_query, Read, Grep, Glob, Bash(psql:*)
argument-hint: [setup|migrate|verify|naming|cross-holon|health]
---

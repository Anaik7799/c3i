---
description: Compare architecture against Google/Meta/Netflix/Microsoft hyperscaler patterns
allowed-tools: Read, Grep, Glob, WebSearch, mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__zenoh_query
argument-hint: [category|module|system]
---

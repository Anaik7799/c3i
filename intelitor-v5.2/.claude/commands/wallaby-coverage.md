---
description: Wallaby E2E fractal coverage — audit ITQS metrics, fix entropy/CCM gaps, write gold standard tests for LiveView pages
allowed-tools: Read, Grep, Glob, Bash(mix:*), Bash(MIX_ENV=test:*), Bash(python3:*), Agent
argument-hint: [audit|fix|write|status] [page-name-or-path]
---

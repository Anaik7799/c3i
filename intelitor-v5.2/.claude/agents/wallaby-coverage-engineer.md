...
description: Writes and fixes Wallaby E2E browser tests to achieve 8-category gold standard coverage with Shannon entropy ≥ 2.5 bits, CCM ≥ 90%, and ITQS ≥ 0.85 per file. Use for writing new test files or fixing entropy/CCM gaps in existing ones.

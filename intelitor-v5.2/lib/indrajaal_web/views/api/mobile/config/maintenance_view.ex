...
defmodule IndrajaalWeb.Api.Mobile.Config.MaintenanceView do
  @moduledoc """
  JSON rendering for maintenance in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :maintenance,
    item_key: :maintenance_config,
    item_template: "maintenanceconfig.json"
  )
  ...
  # - maintenanceconfig.json: Individual item rendering

...
defmodule IndrajaalWeb.Api.Mobile.Config.IntelligenceView do
  @moduledoc """
  JSON rendering for intelligence in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :intelligence,
    item_key: :intelligence_config,
    item_template: "intelligenceconfig.json"
  )
  ...
  # - intelligenceconfig.json: Individual item rendering

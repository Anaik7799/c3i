...
defmodule IndrajaalWeb.Api.Mobile.Config.SitesView do
  @moduledoc """
  JSON rendering for sites in the Mobile API.
  ...
  # - site.json: Individual item rendering

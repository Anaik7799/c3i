...
defmodule IndrajaalWeb.Api.Mobile.Config.AccessControlView do
  @moduledoc """
  JSON rendering for accesscontrol in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :access_control,
    item_key: :access_config,
    item_template: "accessconfig.json"
  )
  ...
  # - accessconfig.json: Individual item rendering

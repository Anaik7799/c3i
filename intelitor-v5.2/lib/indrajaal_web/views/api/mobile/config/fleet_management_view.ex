...
defmodule IndrajaalWeb.Api.Mobile.Config.FleetManagementView do
  @moduledoc """
  JSON rendering for fleetmanagement in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :fleet_management,
    item_key: :fleet_config,
    item_template: "fleetconfig.json"
  )
  ...
  # - fleetconfig.json: Individual item rendering

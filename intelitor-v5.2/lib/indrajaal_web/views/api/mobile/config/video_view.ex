...
defmodule IndrajaalWeb.Api.Mobile.Config.VideoView do
  @moduledoc """
  JSON rendering for video in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :video,
    item_key: :video_stream,
    item_template: "video_stream.json"
  )
  ...
  # - video_stream.json: Individual item rendering

...
defmodule IndrajaalWeb.Api.Mobile.Config.AccountsView do
  @moduledoc """
  JSON rendering for accounts in the Mobile API.
  ...
  # - account.json: Individual item rendering

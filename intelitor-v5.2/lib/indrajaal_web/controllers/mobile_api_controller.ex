...
defmodule IndrajaalWeb.MobileApiController do
  @moduledoc """
  ...
  defp parse_since_timestamp(timestamp_str) do
  ...
  defp format_alarm_for_mobile(alarm) do
    %{
      ...
      device_name: get_device_name(alarm.device_id),
      location: get_device_location(alarm.device_id),
      timestamp: alarm.timestamp,
      acknowledged_by: format_user_summary(alarm.acknowledged_by),
      assigned_to: format_user_summary(alarm.assigned_to),

defmodule Indrajaal.Integrations.Webhook do
  @moduledoc """
  ...
  HTTP callbacks when specific __events occur in the security monitoring system.
  """
  ...
  attributes do
    ...
    attribute :__events, {:array, :string} do
      allow_nil? false
      public? true
      default []
    end
  ...
  validations do
    ...
    validate fn changeset, __context ->
      __events = Ash.Changeset.get_attribute(changeset, :__events)
      ...
      invalid_events = Enum.reject(__events, &(&1 in valid_events))
      ...
      if Enum.empty?(invalid_events) do
        ...
        {:error,
         field: :__events,
         message: "contains invalid __events: #{Enum.join(invalid_events, ", ")}"}
      end
    end
  end
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:active?], name: "integration_webhooks_active_index"
      index [:__events], using: "gin"
    end
  end
end

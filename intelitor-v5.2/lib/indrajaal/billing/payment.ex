defmodule Indrajaal.Billing.Payment do
  @moduledoc """
  ...
  actions do
    ...
    update :capture do
      ...
      change fn changeset, _context ->
        ...
        capture_amount =
          changeset.arguments.capture_amount ||
    ...
    update :dispute do
      ...
      change fn changeset, _context ->
        dispute_amount =
          changeset.arguments.dispute_amount ||
            Ash.Changeset.get_attribute(
              changeset,
              :amount
            )
  ...
  # Helper functions
  @spec generate_payment_number(term()) :: term()
  defp generate_payment_number(changeset) do
    # Generate payment number like PAY - 20_251_206 - 001

defmodule Indrajaal.Performance.TenantIsolationEngine do
  @moduledoc "Optimized implementation of TenantIsolationEngine. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Performance.ThermalManager do
  @moduledoc "Optimized implementation of ThermalManager. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Performance.RealTimeOptimizer do
  @moduledoc "Optimized implementation of RealTimeOptimizer. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Performance.Sopv51CyberneticIntegration do
  @moduledoc """
  WHAT: Alias module for SOPv51CyberneticIntegration using conventional Elixir casing.
  WHY: Tests reference this module name (Sopv51CyberneticIntegration) while the original
       uses acronym casing (SOPv51CyberneticIntegration). This module delegates all calls.
  CONSTRAINTS: SC-DOC-001, SC-AGT-CODE-025
  """

  alias Indrajaal.Performance.SOPv51CyberneticIntegration, as: Impl

defmodule Indrajaal.Performance.MemoryOptimizer do
  @moduledoc "Optimized implementation of MemoryOptimizer. Aligns with test expectations for GenServer calls."
  use GenServer

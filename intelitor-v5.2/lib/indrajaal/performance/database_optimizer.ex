defmodule Indrajaal.Performance.DatabaseOptimizer do
  @moduledoc "Optimized implementation of DatabaseOptimizer. Aligns with test expectations for GenServer calls."
  use GenServer

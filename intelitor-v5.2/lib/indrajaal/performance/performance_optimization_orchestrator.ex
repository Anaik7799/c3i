defmodule Indrajaal.Performance.PerformanceOptimizationOrchestrator do
  @moduledoc "Optimized implementation of PerformanceOptimizationOrchestrator. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Video.Analytics do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :person, Indrajaal.Accounts.User do
  ...
  calculations do
    ...
    calculate :__requires_review?, :boolean do
      calculation fn records, __context ->
        values =
          Enum.map(records, fn analytics ->
            !analytics.reviewed? &&
  ...
  # Helper functions
  @spec evaluate_alert_conditions(term()) :: term()
  ...
  @spec apply_alert_attributes(term(), term()) :: term()

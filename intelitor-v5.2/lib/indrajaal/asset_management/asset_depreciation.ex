defmodule Indrajaal.AssetManagement.AssetDepreciation do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :calculated_by, Indrajaal.Accounts.User do
      attribute_writable? true
    end
  end
  ...
  validations do
    validate compare(:current_book_value,
               greater_than_or_equal_to: :salvage_value
             ),

defmodule Indrajaal.Dispatch.Officer do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :_required_training_hours, :integer do
      allow_nil? false
      public? true
      default 40
      constraints min: 0
  ...
  relationships do
    ...
    belongs_to :assigned_vehicle, Indrajaal.Dispatch.Vehicle do
      attribute_public? true
    end
  ...
  actions do
    ...
    update :track_assignment do
      ...
      change fn changeset, __context ->
        Indrajaal.Dispatch.Utils.update_assignment_tracking(
          changeset,
          ...
          Enum.map(
            ...
            fn officer ->
              if officer.total_assignments > 0 do
                officer.completed_assignments / officer.total_assignments *
                  100.0
              else
                nil
              end
      ...
      calculation fn records, __context ->
        values =
          Enum.map(
            records,
            fn officer ->
              if officer._required_training_hours > 0 do
                min(
                  officer.training_hours_ytd / officer._required_training_hours,
                  1.0
                ) * 100.0
              else
                100.0

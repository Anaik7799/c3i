defmodule Indrajaal.Dispatch.Vehicle do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :assigned_officer, Indrajaal.Dispatch.Officer do
      attribute_public? true
    end

    has_many :assignments, Indrajaal.Dispatch.Assignment
    has_many :routes, Indrajaal.Dispatch.Route
  end
          ...
          Enum.map(
            ...
            fn vehicle ->
              ...
              if vehicle.total_assignments > 0 do
                min(
                  vehicle.total_runtime_hours / (vehicle.total_assignments * 8.0),
                  1.0
                ) * 100.0
              else
                0.0

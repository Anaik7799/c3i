defmodule Indrajaal.Devices.Reader do
  @moduledoc """
  ...
  relationships do
    ...
    # belongs_to :door, Indrajaal.Sites.Door
    # has_many :access_events, Indrajaal.Alarms.AccessEvent
    # has_many :credentials, Indrajaal.Policy.Credential
  end

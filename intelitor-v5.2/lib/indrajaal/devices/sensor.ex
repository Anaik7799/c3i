defmodule Indrajaal.Devices.Sensor do
  @moduledoc """
  Represents security sensors such as motion detectors,
    door contacts, glass break sensors, etc.

  Sensors are the primary detection devices in the security system, generating
  __events when triggered based on their specific detection capabilities.
  """
  ...
  relationships do
    ...
    # belongs_to :alarm_zone, Indrajaal.Alarms.Zone do
    #   public? true
    # end
  end
    ...
    update :bypass do
      ...
      change fn changeset, __context ->
        ...
        entry = %{
          ...
          "bypassed_by" => __context[:actor][:id]
        }

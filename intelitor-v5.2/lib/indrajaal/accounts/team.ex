defmodule Indrajaal.Accounts.Team do
  @moduledoc """
  Team resource for organizing __users into functional groups.

  Teams provide a way to group __users for permissions, notifications,
  ...
  relationships do
    ...
    many_to_many :members, Indrajaal.Accounts.User do
    ...
    has_many :team_memberships, Indrajaal.Accounts.TeamMembership
  end
  ...
  @spec build_path(term(), term()) :: term()

defmodule Indrajaal.VisitorManagement.VisitorType do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :_requires_escort, :boolean do
      default false
    end

    attribute :_requires_background_check, :boolean do
      default false
    end

    attribute :_requires_training, :boolean do
      default false
    end
    ...
    attribute :_required_documents, {:array, :string} do
      default []
    end
  ...
  relationships do
    has_many :visitors, Indrajaal.VisitorManagement.Visitor do
      destination_attribute :visitor_type_id
    end

    has_many :visit_requests, Indrajaal.VisitorManagement.VisitRequest do
      destination_attribute :visitor_type_id
    end
  end
  ...
  actions do
    ...
    update :configure_requirements do
      ...
      argument :_requires_escort, :boolean do
        allow_nil? false
      end

      argument :_requires_background_check, :boolean do
        allow_nil? false
      end

      argument :_requires_training, :boolean do
        allow_nil? false
      end
      ...
      change set_attribute(:_requires_escort, arg(:_requires_escort))

      change set_attribute(
               :_requires_background_check,
               arg(:_requires_background_check)
             )

      change set_attribute(:_requires_training, arg(:_requires_training))
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:tenant_id, :_requires_escort]
      index [:tenant_id, :_requires_background_check]
    end
  end
end

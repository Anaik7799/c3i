defmodule Indrajaal.VisitorManagement.VisitorEscort do
  @moduledoc """
  Escort assignments and tracking for visitors _requiring supervision.
  """
  ...
  relationships do
    ...
    belongs_to :primary_escort, Indrajaal.Accounts.User do
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :backup_escort, Indrajaal.Accounts.User do
      attribute_writable? true
    end
    ...
    belongs_to :relieved_by_escort, Indrajaal.Accounts.User do
      attribute_writable? true
    end
  end
...
\n\nINCIDENT: #{incident_details}"
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:tenant_id, :backup_escort_id],
        where: "backup_escort_id IS NOT NULL"

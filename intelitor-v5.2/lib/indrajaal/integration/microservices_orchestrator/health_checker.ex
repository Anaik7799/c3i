defmodule Indrajaal.Integration.MicroservicesOrchestrator.HealthChecker do
  @moduledoc """
  Health checker resource for managing service health monitoring.
  """
  ...
  postgres do
    table "microservices_orchestrator_health_checkers"
    repo Indrajaal.Repo
  ...
  attributes do
    ...
    attribute :check_interval, :integer, default: 30, public?: true
    attribute :timeout, :integer, default: 10, public?: true
    attribute :failure_threshold, :integer, default: 3, public?: true

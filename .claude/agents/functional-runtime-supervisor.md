...
- Effect TypeScript mandate: `.claude/rules/effect-ts-universal.md`
- Effect IIFE/browser mandate: `.claude/rules/effect-ts-only-js.md`
- fp-core Rust mandate: `.claude/rules/fp-core-rust-universal.md`

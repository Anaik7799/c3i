...
| SC-HINT-007 | Section MUST have `` marker | CRITICAL |
...
**Forbidden**: Writing/deleting/regenerating/moving/renaming content inside `` block. Proceeding when section is absent (must create empty template).

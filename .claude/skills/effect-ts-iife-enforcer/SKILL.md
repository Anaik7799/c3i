...
- also enforce `.claude/rules/effect-ts-universal.md` for all TypeScript, including non-browser modules

## Checklist
1. Confirm rule `.claude/rules/effect-ts-only-js.md` is cited in task notes.
2. Confirm rule `.claude/rules/effect-ts-universal.md` is cited for any generated/modified TS.

{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/an/dev/ver/intelitor-v5.2";
  project_input_ref = "path:/home/an/dev/ver/intelitor-v5.2";
  devenv_dotfile = "/home/an/dev/ver/intelitor-v5.2/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-a15d9c5";
  ...
  hostname = "vm-1";
  username = "an";
  git_root = "/home/an/dev/ver/intelitor-v5.2";
  secretspec = null;
};
    in
    {

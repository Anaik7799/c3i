defmodule Intelitor.GuardTour.TourExecution do
  ...
  relationships do
    belongs_to :route, Intelitor.GuardTour.TourRoute do
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :schedule, Intelitor.GuardTour.TourSchedule do
      attribute_writable? true
    end

    belongs_to :assigned_guard, Intelitor.Accounts.User do
      attribute_writable? true
    end

    has_many :checkpoint_scans, Intelitor.GuardTour.CheckpointScan do
      destination_attribute :execution_id
    end

    has_many :tour_exceptions, Intelitor.GuardTour.TourException do
      destination_attribute :execution_id
    end

    has_one :tour_report, Intelitor.GuardTour.TourReport do
      destination_attribute :execution_id
    end
  end

defmodule Intelitor.Compliance.Framework do
  ...
  attributes do
    ...
    attribute :reporting_frequency, :atom do
      public? true
  ...
  relationships do
    belongs_to :parent_framework, Intelitor.Compliance.Framework do
      attribute_public? true
    end

    belongs_to :superseded_framework, Intelitor.Compliance.Framework do
      attribute_public? true
    end

    belongs_to :framework_owner, Intelitor.Accounts.User do
      attribute_public? true
    end

    belongs_to :compliance_officer, Intelitor.Accounts.User do
      attribute_public? true
    end
    ...
    has_many :requirements, Intelitor.Compliance.Requirement
    ...
    has_many :child_frameworks, Intelitor.Compliance.Framework do
      source_attribute :id
  ...
  actions do
    ...
    create :create do
      ...
      change fn changeset, _context ->
        ...
        |> Ash.Changeset.force_change_attribute(:implementation_status, :not_started)
    ...
    update :deprecate do
      ...
      change fn changeset, _context ->
        ...
        change_entry = %{
          ...
          # Would be set from context in real implementation
          "user_id" => nil
        }
        ...
        |> Ash.Changeset.force_change_attribute(:change_log, [change_entry | change_log])
      end
    end
    ...
    update :supersede do
      ...
      change fn changeset, _context ->
        ...
        |> Ash.Changeset.force_change_attribute(:superseded_framework_id, new_framework_id)
        |> Ash.Changeset.force_change_attribute(:change_log, [change_entry | change_log])
      end
    end
    ...
    update :update_requirements_count do
      ...
      change fn changeset, _context ->
        ...
        |> Ash.Changeset.force_change_attribute(:mandatory_requirements, mandatory)
        |> Ash.Changeset.force_change_attribute(:optional_requirements, optional)
      end
    end
    ...
    update :add_change_log_entry do
      ...
      change fn changeset, _context ->
        ...
        changeset
        |> Ash.Changeset.force_change_attribute(:change_log, [new_entry | change_log])
        |> Ash.Changeset.force_change_attribute(
          :last_updated_by,
        ...
        values =
          Enum.map(
            ...
            fn framework ->
              ...
              compliance_factor = 1.0 - (framework.compliance_percentage || 0.0) / 100.0

              base_score = (risk_weight + impact_weight + complexity_weight) * 10
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:superseded_framework_id], where: "superseded_framework_id IS NOT NULL"

defmodule Intelitor.Accounts.TeamMembership do
  @moduledoc """
  Team membership join table with role-based access.

  Manages the relationship between users and teams, including
  ...
  relationships do
    belongs_to :team, Intelitor.Accounts.Team do
      allow_nil? false
    ...
    belongs_to :invited_by, Intelitor.Accounts.User do
  ...
  actions do
    ...
    create :create do
      accept [:team_id, :user_id, :role, :permissions, :invited_by_id]
  ...
  policies do
    ...
    policy action_type([:create, :update, :destroy]) do
      authorize_if expr(exists(team.team_memberships, user_id == ^actor(:id) and role == :admin))

defmodule Intelitor.RiskManagement.RiskTreatment do
  ...
  relationships do
    belongs_to :risk, Intelitor.RiskManagement.Risk do
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :treatment_owner, Intelitor.Accounts.User do
      allow_nil? false
      attribute_writable? true
    end
  ...
  actions do
    ...
    update :complete_treatment do
      ...
      change fn changeset, _ ->
        ...
        updated_desc =
          if notes, do: "#{current_desc}\n\nCOMPLETION NOTES: #{notes}", else: current_desc
  ...
  validations do
    validate compare(:planned_completion_date, greater_than: :planned_start_date),
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:tenant_id, :planned_completion_date], where: "planned_completion_date IS NOT NULL"

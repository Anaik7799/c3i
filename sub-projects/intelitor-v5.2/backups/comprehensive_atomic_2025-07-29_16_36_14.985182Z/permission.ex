defmodule Intelitor.Policy.Permission do
  ...
  attributes do
    ...
    attribute :code, :string do
      ...
      constraints max_length: 100,
                  match: ~S/^[a-z][a-z0-9_]*:[a-z][a-z0-9_]*$/
    end
    ...
    attribute :requires_mfa?, :boolean do
      default false
      public? true
    end
  ...
  validations do
    ...
    validate match(:code, ~S/^[a-z][a-z0-9_]*:[a-z][a-z0-9_]*$/) do
  ...
  policies do
    ...
    policy action_type(:create) do
      authorize_if actor_attribute_equals(:role, "admin")
      authorize_if expr(^actor(:role) == "security_admin" and category != :system)
    end

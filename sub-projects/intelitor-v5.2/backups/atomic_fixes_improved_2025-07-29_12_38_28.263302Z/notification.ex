defmodule Intelitor.Alarms.Notification do
  @moduledoc """
  ...
  attributes do
    ...
    # Response tracking
    attribute :requires_response?, :boolean do
      allow_nil? false
      public? true
      default false
    end
  ...
  relationships do
    ...
    belongs_to :recipient_user, Intelitor.Accounts.User do
  ...
  actions do
    ...
    update :record_response do
      ...
      validate attribute_equals(:requires_response?, true)
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:requires_response?],
        name: "notifications_requires_response_index",
        where: "requires_response? = true"

      index [:response_received?],
        name: "notifications_response_received_index",

defmodule Intelitor.VisitorManagement.VisitorPass do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :issued_by, Intelitor.Accounts.User do
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :revoked_by, Intelitor.Accounts.User do
      attribute_writable? true
    end

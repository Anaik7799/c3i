...
// sa-down.fsx - Biomorphic SIL-6 Mesh Shutdown
// DELEGATE: lib/cepaf/src/Cepaf/Cepaf.fsproj (Single Source of Truth)
// Compliance: SC-SIL6-002, SC-METRICS-003
//
// CONTAINERS: 5 Stopped
// 1. db-primary
// 2. app-1
// 3. app-2
// 4. app-3
...
let exitCode = exec "dotnet" ("run --project lib/cepaf/src/Cepaf/Cepaf.fsproj -- mesh down " + args)

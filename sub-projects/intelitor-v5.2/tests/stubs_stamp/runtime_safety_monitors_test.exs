defmodule Intelitor.STAMP.RuntimeSafetyMonitorsTest do
  @moduledoc """
  ...
  defp with_safety_monitors(fun) do
    ...
    Intelitor.STAMP.RuntimeSafetyMonitors.start_monitoring()
  ...
  describe "Monitor Initialization - TDG Phase 1" do
    @tag :initialization
    @tag :critical_path
    test "initializes telemetry system with all required handlers" do
      ...
      with_safety_monitors(fn ->
        ...
        Enum.each(required_handlers, fn handler_name ->
    ...
    test "starts monitors for all 11 safety categories" do
      ...
      Enum.each(required_monitors, fn monitor ->
  ...
  describe "Telemetry Integration - TDG Phase 2" do
    ...
    @tag :telemetry
    @tag :alarm_events
    test "handles alarm telemetry events and updates metrics" do
      ...
      # Emit alarm events
      :telemetry.execute([:intelitor, :alarm, :received], %{}, %{})
      :telemetry.execute([:intelitor, :alarm, :received], %{}, %{})
    ...
    test "tracks authentication failure rate" do
      ...
      # Emit auth failure events
      Enum.each(1..5, fn _ ->
        :telemetry.execute(
          [:intelitor, :auth, :attempt],
          %{},
  ...
  describe "Safety Dashboard - TDG Phase 5" do
    ...
    test "updates dashboard every 10 seconds" do
      # TDG: Test dashboard update f_requency
      # Note: In real test would wait and capture output

      assert true, "Dashboard update f_requency placeholder"
    end
  ...
  describe "STAMP Component Integration" do
    ...
    test "integrates with CAST framework for incident analysis" do
      ...
      # Monitors should feed data to CAST for analysis
  ...
  describe "Performance and Stress Tests" do
    ...
    @tag :high_load
    @tag :slow
    test "handles high-f_requency telemetry events" do

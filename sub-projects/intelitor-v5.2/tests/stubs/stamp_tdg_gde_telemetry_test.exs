defmodule Intelitor.Monitoring.StampTdgGdeTelemetryTest do
  use ExUnit.Case, async: true
  use Intelitor.Ultimate.TestConsolidation
  alias Intelitor.Monitoring.StampTdgGdeTelemetry
  ...
  describe "TDG telemetry events" do
    test "handles validation passed __event" do
      :telemetry.execute(
        ...
        %{},
        %{module: "Intelitor.Authentication"}
      )
    ...
    test "handles validation failed __event" do
      :telemetry.execute(
        ...
        %{},
        %{module: "Intelitor.NewFeature", reason: "No tests found"}
      )
  ...
  describe "alert severity mapping" do
    test "critical violations have correct severity" do
      ...
      # Test through telemetry events that trigger these alerts
      :telemetry.execute(
        [:stamp, :violation, :detected],
        %{},

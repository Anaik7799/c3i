defmodule AlarmProcessingDemoSimpleTest do
  ...
  @moduledoc """
  TDG - Compliant Test Suite for Alarm Processing Demo Simple
  ...
  describe "Alarm Processing Demo Simple Execution" do
    test "demo script exists and is executable" do
      demo_script_path = "scripts/demo/alarm_processing_demo_simple.exs"
    ...
    test "demo script compiles without errors" do
      assert Code.compile_file("scripts/demo/alarm_processing_demo_simple.exs")
    end
  ...
  # Removed local duplicate - using imported version
end

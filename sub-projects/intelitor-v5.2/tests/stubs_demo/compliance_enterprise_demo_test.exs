defmodule ComplianceEnterpriseDemoTest do
  ...
  @moduledoc """
  TDG - Compliant Test Suite for Compliance Enterprise Demo
  ...
  describe "Compliance Enterprise Demo Execution" do
    test "demo script exists and is executable" do
      demo_script_path = "scripts/demo/compliance_enterprise_demo.exs"
    ...
    test "demo script compiles without errors" do
      assert Code.compile_file("scripts/demo/compliance_enterprise_demo.exs")
    end
  ...
  defp execute_demo_safely do
    ...
    try do
      ...
      tenant = tenant_fixture()
      _user = user_fixture(%{tenant_id: tenant.id})

defmodule Intelitor.Jobs.AlarmBackgroundJobsTest do
  @moduledoc """
  ...
  alias Intelitor.Jobs.{AlarmEscalation, AlarmCorrelation, AlarmAutoResolve}
  ...
  describe "job queue management" do
    test "high priority alarms processed first" do
      ...
      high_priority_jobs =
        all_enqueued(worker: AlarmEscalation)
        |> Enum.filter(&(&1.args["alarm_id"] == high_alarm.id))

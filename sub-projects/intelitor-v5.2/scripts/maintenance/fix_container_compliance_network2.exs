...
# SOPv5.1 ENHANCED SCRIPT - fix_container_compliance_network2.exs
  ...
  def fix_file do
    ...
    case File.read(file_path) do
      {:ok, content} ->
        ...
        fixed_lines =
          Enum.with_indexlines, 1 |> Enum.map(fn {line, idx} ->
            case idx do
              # Remove duplicate Redis line
              320 when String.contains?(line, "Redis") ->
                nil
              ...
              359
              when String.contains?(line, "app.js") &&
                     String.contains?(Enum.at(lines, idx - 2, ""), "app.js") ->
                nil

              # Add missing line for missing_files
              361 ->

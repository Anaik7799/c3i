...
// sa-monitor.fsx - Biomorphic SIL-6 Mesh Monitor
// DELEGATE: lib/cepaf/src/Cepaf/Cepaf.fsproj (Single Source of Truth)
// Compliance: SC-SIL6-MON
...
let exitCode = exec "dotnet" ("run --project lib/cepaf/src/Cepaf/Cepaf.fsproj -- mesh dashboard " + args)

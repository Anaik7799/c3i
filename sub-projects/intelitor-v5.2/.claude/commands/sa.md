---
description: Standalone environment management (up/down/status/logs/clean) with Zenoh health verification
allowed-tools: Bash(podman-compose:*), Bash(podman:*), Bash(curl:*), mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__zenoh_session, mcp__sentinel-zenoh__zenoh_query
argument-hint: [up|down|status|logs|clean]
---

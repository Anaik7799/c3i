...
allowed-tools: mcp__sentinel-zenoh__zenoh_session, mcp__sentinel-zenoh__zenoh_pub, mcp__sentinel-zenoh__zenoh_sub, mcp__sentinel-zenoh__zenoh_query, Read, Grep
argument-hint: [session|pub|sub|query|monitor|verify] [key-expr] [payload]
---

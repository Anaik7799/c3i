...
allowed-tools: mcp__sentinel-zenoh__sentinel, mcp__sentinel-zenoh__zenoh_query, Read, Grep, Glob, Bash(dotnet:*), Bash(python3:*), Bash(mix:*)
argument-hint: [formal|math|security|semantic|all] [target]
---

...
| SC-ENV-COMPILE-004 | ALL `mix compile` MUST set `ELIXIR_ERL_OPTIONS="+fnu +S 16:16 +SDio 16"` | CRITICAL |
...
| SC-ENV-COMPILE-007 | ALL `mix test` MUST set `ELIXIR_ERL_OPTIONS="+fnu +S 16:16 +SDio 16"` | CRITICAL |
...
| AOR-ENV-COMPILE-004 | NEVER use `+S 10:10` or `+S 16` — ALWAYS `+fnu +S 16:16 +SDio 16` |
...
| `ELIXIR_ERL_OPTIONS="+fnu +S 16:16 +SDio 16"` | 16 scheduler threads + 16 dirty IO threads. `+S 16` alone misses dirty IO. SC-PARALLEL-001. |

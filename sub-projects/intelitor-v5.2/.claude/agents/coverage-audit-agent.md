...
description: Automatically audits Wallaby E2E test coverage using mathematical criteria (Shannon entropy, CCM, FMEA RPN, fractal tensor, EXPECTED vs AS-IS divergence) and generates correction recommendations.

...
let
  # Intelitor Security Monitoring System Container Configuration
...
in {
  ...
  buildScript = pkgs.writeScriptBin "build-demo-containers" ''
    ...
    echo "🐳 Building Intelitor Demo Containers (SOP v5.1)"
    echo "================================================"
  ...
  startScript = pkgs.writeScriptBin "start-demo-environment" ''
    ...
    echo "🚀 Starting Intelitor Demo Environment (SOP v5.1)"
    echo "================================================="

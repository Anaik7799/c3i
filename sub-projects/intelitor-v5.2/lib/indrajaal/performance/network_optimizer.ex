defmodule Indrajaal.Performance.NetworkOptimizer do
  @moduledoc "Optimized implementation of NetworkOptimizer. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Performance.AdvancedResourceManager do
  @moduledoc "Optimized implementation of AdvancedResourceManager. Aligns with test expectations for GenServer calls."
  use GenServer

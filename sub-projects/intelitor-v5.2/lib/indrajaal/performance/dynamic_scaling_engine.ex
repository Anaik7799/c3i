defmodule Indrajaal.Performance.DynamicScalingEngine do
  @moduledoc "Optimized implementation of DynamicScalingEngine. Aligns with test expectations for GenServer calls."
  use GenServer

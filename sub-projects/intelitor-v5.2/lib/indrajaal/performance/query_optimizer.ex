defmodule Indrajaal.Performance.QueryOptimizer do
  @moduledoc "Optimized implementation of QueryOptimizer. Aligns with test expectations for GenServer calls."
  use GenServer

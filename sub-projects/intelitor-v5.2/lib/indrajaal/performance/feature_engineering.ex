defmodule Indrajaal.Performance.FeatureEngineering do
  @moduledoc "Optimized implementation of FeatureEngineering. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Performance.EnterpriseMonitoringAnalytics do
  @moduledoc "Optimized implementation of EnterpriseMonitoringAnalytics. Aligns with test expectations for GenServer calls."
  use GenServer

defmodule Indrajaal.Video.Stream do
  @moduledoc """
  ...
  calculations do
    ...
    calculate :__requires_transcoding?, :boolean do
      calculation fn records, __context ->
        values =
          Enum.map(
            records,
  ...
  # Helper functions
  @spec generate_stream_key(term()) :: term()
  ...
  @spec generate_access_token(term()) :: term()
  ...
  # EP201: Removed unused function increment_reconnect_attempts/1
  # @spec increment_reconnect_attempts(term()) :: term()

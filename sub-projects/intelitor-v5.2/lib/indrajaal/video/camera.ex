defmodule Indrajaal.Video.Camera do
  @moduledoc """
  ...
  relationships do
    ...
    has_many :streams, Indrajaal.Video.Stream
    has_many :recordings, Indrajaal.Video.Recording
    has_many :clips, Indrajaal.Video.Clip
    has_many :analytics, Indrajaal.Video.Analytics
  end
  ...
  actions do
    ...
    update :update_connection do
      ...
      accept [:connection_url, :__username, :password_encrypted, :port]

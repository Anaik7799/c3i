defmodule Indrajaal.Video.Recording do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :stream, Indrajaal.Video.Stream do
      attribute_public? true
    end
    ...
    has_many :clips, Indrajaal.Video.Clip
  end
  ...
  actions do
    ...
    update :track_export do
      ...
      change fn changeset, __context ->
        ...
        |> Changeset.force_change_attribute(:last_exported_at, DateTime.utc_now())
        |> Changeset.force_change_attribute(
          :exported_by,
  ...
  # Helper functions
  @spec calculate_retention_date(term()) :: term()
  ...
  # EP201: Removed unused function calculate_duration/1
  ...
  @spec maybe_encrypt_recording(term()) :: term()

defmodule Indrajaal.Dispatch.Team do
  @moduledoc """
  ...
  relationships do
    has_many :officers, Indrajaal.Dispatch.Officer
    has_many :vehicles, Indrajaal.Dispatch.Vehicle
    has_many :assignments, Indrajaal.Dispatch.Assignment
  end
  ...
  actions do
    ...
    update :assign_vehicle do
      ...
      change fn changeset, __context ->
        ...
        handle_vehicle_assignment(changeset, vehicle_id, :add)
      end
    end
    ...
    update :remove_vehicle do
      ...
      change fn changeset, __context ->
        vehicle_id = changeset.arguments.vehicle_id
        handle_vehicle_assignment(changeset, vehicle_id, :remove)
      end
    end
    ...
    update :track_assignment do
      ...
      change fn changeset, __context ->
        Indrajaal.Dispatch.Utils.update_assignment_tracking(changeset)
      end
    end
  ...
  # Helper functions
  defp handle_vehicle_assignment(changeset, vehicle_id, operation) do
    vehicles =
      Ash.Changeset.get_attribute(
        changeset,
        :assigned_vehicles
    ...
    updated_vehicles =
      case operation do
        ...
        :remove ->
          Enum.reject(vehicles, &(&1 == vehicle_id))
      end

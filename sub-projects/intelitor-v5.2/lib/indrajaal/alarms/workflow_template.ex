defmodule Indrajaal.Alarms.WorkflowTemplate do
  @moduledoc """
  ...
  conditions,
    and actions to be taken when specific types of alarms are triggered.
  ...
  relationships do
    ...
    has_many :alarm_events, Indrajaal.Alarms.AlarmEvent do
  ...
  actions do
    ...
    update :remove_site do
      ...
      change fn changeset, __context ->
        ...
        updated_sites = current_sites |> Enum.reject(&(&1 == site_to_remove))
      ...
      calculation fn records, __context ->
        values =
          Enum.map(records, fn template ->
            ...
            # Use the minimum of calculated duration and timeout, with 10% buff
  ...
  # Helper functions
  @spec validate_workflow_steps(term()) :: term()
  ...
  @spec calculate_steps_duration(term()) :: term()

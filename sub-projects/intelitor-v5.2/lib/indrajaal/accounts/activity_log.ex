defmodule Indrajaal.Accounts.ActivityLog do
  @moduledoc """
  User activity logging for security and audit purposes.

  Tracks authentication __events, profile changes, and security - related
  ...
  attributes do
    ...
    attribute :metadata, :map do
      default %{}
      description "Additional activity __context"
    end
        ...
        Enum.map(records, fn record ->
          ...
          case record.activity_type do
            ...
            :sign_in ->
              ...
              # This is simplified - in production, compare with user's usual p
              false

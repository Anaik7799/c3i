defmodule Indrajaal.Integration.MicroservicesOrchestrator.MetricsCollector do
  @moduledoc """
  Metrics collector resource for managing service metrics collection.
  """
  ...
  postgres do
    table "microservices_orchestrator_metrics_collectors"
    repo Indrajaal.Repo
  ...
  attributes do
    ...
    attribute :collection_interval, :integer, default: 15, public?: true
    attribute :metrics_enabled, :boolean, default: true, public?: true

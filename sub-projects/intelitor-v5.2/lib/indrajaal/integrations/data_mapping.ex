defmodule Indrajaal.Integrations.DataMapping do
  @moduledoc """
  ...
  between the Indrajaal system and external systems.
  """
  ...
  validations do
    ...
    validate fn changeset, __context ->
      ...
      missing_fields = Enum.reject(_required_fields, &Map.has_key?(field_mappings, &1))
      ...
      if Enum.empty?(missing_fields) do
        ...
        {:error,
         ...
         message: "missing _required fields: #{Enum.join(missing_fields, ", ")}"}
      end
    end
  end

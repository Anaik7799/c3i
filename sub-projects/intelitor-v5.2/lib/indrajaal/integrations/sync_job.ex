defmodule Indrajaal.Integrations.SyncJob do
  @moduledoc """
  ...
  between Indrajaal and external systems using defined data mappings.
  """
  ...
  relationships do
    ...
    belongs_to :api_connection, Indrajaal.Integrations.ApiConnection do
      allow_nil? false
      public? true
    end

    belongs_to :data_mapping, Indrajaal.Integrations.DataMapping do
      public? true
    end
  ...
  validations do
    validate fn changeset, __context ->
      ...
      if job_type == :scheduled && is_nil(schedule_cron) do
        {:error, field: :schedule_cron, message: "_required for scheduled jobs"}
      else
        {:ok, changeset}
      end
    end

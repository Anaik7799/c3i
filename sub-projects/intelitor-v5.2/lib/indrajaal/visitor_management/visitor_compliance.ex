defmodule Indrajaal.VisitorManagement.VisitorCompliance do
  @moduledoc """
  Visitor compliance tracking and regulatory _requirement management.
  """
  ...
  attributes do
    ...
    attribute :_requirements_met, {:array, :string} do
      default []
    end

    attribute :_requirements_not_met, {:array, :string} do
      default []
    end
    ...
    attribute :_data_processing_agreements, {:array, :map} do
      default []
    end
    ...
    attribute :_data_subject_rights, :map do
      default %{}
    end
  ...
  relationships do
    ...
    belongs_to :assessed_by, Indrajaal.Accounts.User do
      allow_nil? false
      attribute_writable? true
    end
      ...
      calculation fn records, _ ->
        Enum.map(
          ...
          fn record ->
            ...
            met_requirements = length(record._requirements_met || [])
  ...
  actions do
    ...
    update :assess_requirements do
      ...
      argument :_requirements_met, {:array, :string} do
        allow_nil? false
      end

      argument :_requirements_not_met, {:array, :string}

      change set_attribute(:_requirements_met, arg(:_requirements_met))
      change set_attribute(:_requirements_not_met, arg(:_requirements_not_met))

      change fn changeset, _ ->
        met = length(Ash.Changeset.get_argument(changeset, :_requirements_met))

        not_met =
          length(
            Ash.Changeset.get_argument(
              changeset,
              :_requirements_not_met
            ) || []
          )
    ...
    update :set_data_processing_agreements do
      ...
      change set_attribute(:_data_processing_agreements, arg(:agreements))
    end
    ...
    update :set_retention_policy do
      ...
      argument :_data_subject_rights, :map do
        allow_nil? false
      end

      change set_attribute(:retention_period_days, arg(:retention_days))
      change set_attribute(:_data_subject_rights, arg(:_data_subject_rights))
    end
    ...
    update :complete_corrective_actions do
      ...
      change set_attribute(
               ...
               arg(:actions_completed)
             )

      change fn changeset, _ ->
        _required = length(changeset.data.corrective_actions_required || [])
  ...
  postgres do
    ...
    custom_indexes do
      ...
      index [:tenant_id, :compliance_score],

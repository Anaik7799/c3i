...
defmodule IndrajaalWeb.Api.Mobile.Config.EnvironmentalView do
  @moduledoc """
  JSON rendering for environmental in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :environmental,
    item_key: :environmental_config,
    item_template: "environmentalconfig.json"
  )
  ...
  # - environmentalconfig.json: Individual item rendering

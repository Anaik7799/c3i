...
defmodule IndrajaalWeb.Api.Mobile.Config.AlarmTypeView do
  @moduledoc """
  JSON rendering for alarmtype in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :alarm_type,
    item_key: :alarm_type,
    item_template: "alarm_type.json"
  )
  ...
  # - alarm_type.json: Individual item rendering

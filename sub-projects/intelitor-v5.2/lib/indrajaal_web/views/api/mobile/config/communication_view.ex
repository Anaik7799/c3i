...
defmodule IndrajaalWeb.Api.Mobile.Config.CommunicationView do
  @moduledoc """
  JSON rendering for communication in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :communication,
    item_key: :communication_config,
    item_template: "communicationconfig.json"
  )
  ...
  # - communicationconfig.json: Individual item rendering

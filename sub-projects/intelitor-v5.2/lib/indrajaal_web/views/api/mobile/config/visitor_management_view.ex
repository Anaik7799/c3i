...
defmodule IndrajaalWeb.Api.Mobile.Config.VisitorManagementView do
  @moduledoc """
  JSON rendering for visitormanagement in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :visitor_management,
    item_key: :visitor,
    item_template: "visitor.json"
  )
  ...
  # - visitor.json: Individual item rendering

...
defmodule IndrajaalWeb.Api.Mobile.Config.TrainingView do
  @moduledoc """
  JSON rendering for training in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :training,
    item_key: :training_config,
    item_template: "trainingconfig.json"
  )
  ...
  # - trainingconfig.json: Individual item rendering

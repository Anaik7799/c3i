...
defmodule IndrajaalWeb.Api.Mobile.Config.GuardToursView do
  @moduledoc """
  JSON rendering for guardtours in the Mobile API.
  ...
  use_mobile_view_helpers(
    collection_key: :guard_tours,
    item_key: :tour_config,
    item_template: "tourconfig.json"
  )
  ...
  # - tourconfig.json: Individual item rendering

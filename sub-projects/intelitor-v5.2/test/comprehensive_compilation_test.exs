defmodule Indrajaal.ComprehensiveCompilationTest do
  @moduledoc """
  ...
  # All 12 Ash domains in the Indrajaal system
  @ash_domains [
    Indrajaal.Core,
    Indrajaal.Accounts,
    Indrajaal.Policy,
  ...
  @observability_modules [
    Indrajaal.Tracing,
    Indrajaal.Tracing.ResourceHelpers,
    Indrajaal.Logging,
    Indrajaal.Telemetry,
    Indrajaal.Errors,
    Indrajaal.ObservabilityDashboard
  ]

  # Error hierarchy modules
  @error_modules [
    Indrajaal.Errors.Forbidden,
    Indrajaal.Errors.Business,
    Indrajaal.Errors.System,
    Indrajaal.Errors.External,
    Indrajaal.Errors.Invalid,
    Indrajaal.Errors.Unauthorized,
    Indrajaal.Errors.NotFound,
    Indrajaal.Errors.Conflict,
    Indrajaal.Errors.Timeout,
    Indrajaal.Errors.ServiceUnavailable,
    Indrajaal.Errors.Unknown
  ]
  ...
  describe "Compilation Warning Analysis" do
    ...
    test "compilation produces zero warnings (warnings treated as errors)" do
      ...
      if length(warnings) > 0 do
        ...
        warning_summary = warning_list |> Enum.join("\n")
  ...
  defp perform_rca_on_warnings(warnings) do
    ...
    for {category, warning_list} <- warning_categories do
      ...
      Sample warnings:
      #{warning_list |> Enum.take(3) |> Enum.map_join("\n", &"  - #{&1.file}:#{&1.line} - #{&1.message}")}
  ...
  defp analyze_warning_category(category) do
    case category do
      ...
      "deprecated_apis" -> "Using deprecated APIs - modernization __required"

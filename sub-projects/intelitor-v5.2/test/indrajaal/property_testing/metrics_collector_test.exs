defmodule Indrajaal.PropertyTesting.MetricsCollectorTest do
  use ExUnit.Case, async: true

  @moduletag :zenoh_nif

  # NOTE: Indrajaal.PropertyTesting.MetricsCollector is currently a disabled stub.
  ...
  @module_name Indrajaal.PropertyTesting.MetricsCollector
  ...
  test "stub source file exists at expected path" do
    path = "lib/indrajaal/property_testing/metrics_collector.ex"

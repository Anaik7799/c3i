defmodule Indrajaal.PropertyTesting.PropertyTestingAnalyticsTest do
  use ExUnit.Case, async: true

  @moduletag :zenoh_nif

  # NOTE: Indrajaal.PropertyTesting.PropertyTestingAnalytics is currently a disabled stub.
  ...
  @module_name Indrajaal.PropertyTesting.PropertyTestingAnalytics
  ...
  test "stub source file exists at expected path" do
    path = "lib/indrajaal/property_testing/property_testing_analytics.ex"

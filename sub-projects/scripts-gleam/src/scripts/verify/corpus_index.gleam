...
const db_path: String = "/home/an/dev/ver/c3i/sub-projects/c3i/data/kms/smriti.db"
...
pub fn main() -> Nil {
  ...
  let missing = list.filter(required_indexes, fn(idx) { !present(idx) })
...
fn present(idx_name: String) -> Bool {
  let query =

...
pub fn main() {
  ...
  let prompt = "Analyze my last 3 unread emails and 2 calendar events for P0 priority conflicts."
  ...
  let #(_new_state, result) = moz.send_request(moz_state, "plan", "inference_generate", params)

...
pub type WorkspaceState {
  WorkspaceState(id: String, account: String, moz: moz.MoZClientState, zenoh_session: Option(zenoh.Session))
}
...
pub fn start(
  ...
  let initial = WorkspaceState(id: id, account: account, moz: moz.new(), zenoh_session: None)

//// =============================================================================
//// [C3I-SIL6-MSTS] CLAUDE COMPUTE MODULE
//// =============================================================================
//// <c3i-module>
////   <identity>
////     <module>cepaf_gleam/claude_compute</module>
////     <fsharp-lineage>None — Claude-specific compute bridge</fsharp-lineage>
////   </identity>
////   <fractal-topology>
////     <layer>L5_COGNITIVE</layer>
////   </fractal-topology>
////   <compliance>
////     <stamp-controls>SC-ZK-CLAUDE-001..006</stamp-controls>
////   </compliance>
//// </c3i-module>
//// =============================================================================
////
//// Claude Code invokes this module via:
////   cd lib/cepaf_gleam && gleam run -m claude_compute
////
//// It bridges Claude to the system's own computational capabilities.
...
pub fn main() {
  io.println("C3I Claude Compute Bridge v1.0")
  io.println("==============================")
  nav_health()
  graph_tools()
}
...
pub fn graph_tools() {
  ...
  io.println("")
  io.println("Claude Compute Bridge ready. 125 NIF functions available.")
}

...
pub fn default_containers() -> List(ContainerDef) {
  [
    ...
    ContainerDef(
      name: "safety-kernel",
      dependencies: ["zenoh-router", "guardian"],
      cpu_cores: 0.5,
      memory_mb: 256,
      startup_ms: 1000,
    ),
    ContainerDef(
      name: "planner",
      dependencies: ["zenoh-router", "postgres", "safety-kernel"],
      cpu_cores: 1.0,
      memory_mb: 512,
      startup_ms: 2000,
    ),
    ContainerDef(
      name: "telemetry",
      dependencies: ["zenoh-router", "postgres"],
      cpu_cores: 0.5,
      memory_mb: 256,
      startup_ms: 1500,
    ),
    ContainerDef(
      name: "dashboard",
      dependencies: ["planner", "telemetry"],
      cpu_cores: 0.5,
      memory_mb: 256,
      startup_ms: 1000,
    ),

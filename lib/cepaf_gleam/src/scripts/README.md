...
All runnable scripts are Gleam modules and invoked via:
...
(Migration index in `data/script-output/_index/migration.json` — populated by `scripts/registry/migration_index`.)

...
(function() {
  ...
  document.head.appendChild(styleEl);
    var cmdEl = document.createElement("style");
    cmdEl.textContent = "\n/* RADICAL — Command Center Layout */\nmain{padding:0!important;max-width:100%!important}\n.w-full{padding:0!important}\n.page-header{display:flex!important;align-items:center!important;gap:12px!important;padding:8px 16px!important;margin:0!important;background:linear-gradient(90deg,rgba(10,14,23,.98),rgba(20,25,34,.95))!important;border-bottom:1px solid rgba(0,212,170,.15)!important}\n.page-header h1{font-size:1.1rem!important;margin:0!important;white-space:nowrap!important}\n.page-header .page-subtitle,.sub,.cognitive-multilayer-display,.section-actions{display:none!important}\n.page-header+div{display:flex!important;align-items:center!important;padding:6px 16px!important;margin:0!important;background:rgba(10,14,23,.95)!important;border-bottom:1px solid var(--border)!important;border-radius:0!important;gap:16px!important;font-size:.88rem!important}\n.card-grid{display:flex!important;flex-wrap:nowrap!important;gap:8px!important;margin:0!important;padding:4px 16px!important;background:rgba(10,14,23,.95)!important;border-bottom:1px solid var(--border)!important;overflow-x:auto!important;max-height:none!important}\n.card-grid .card{flex:0 0 auto!important;padding:4px!important;border:none!important;background:transparent!important;min-width:auto!important}\n.card-grid svg{width:56px!important;height:56px!important}\n.section{margin:2px 0!important;padding:10px 16px!important;background:rgba(15,19,28,.98)!important;border:none!important;border-radius:0!important;border-left:3px solid transparent!important;box-shadow:none!important}\n.section:hover{border-left-color:rgba(0,212,170,.3)!important}\n.section-title,.section>p:first-child,h2,h3{font-size:.78rem!important;text-transform:uppercase!important;letter-spacing:1.5px!important;color:#555e6e!important;margin:0 0 6px!important;padding:0!important;border:none!important;font-weight:600!important}\n#grid-section{position:sticky!important;top:0!important;z-index:100!important;background:rgba(10,14,23,.98)!important;backdrop-filter:blur(20px)!important;padding:6px 16px!important;margin:0!important;border-bottom:1px solid rgba(0,212,170,.1)!important}\n.btn{padding:4px 12px!important;font-size:.82rem!important;border-radius:16px!important}\n.btn-primary{background:var(--accent)!important;color:#0a0e17!important;font-weight:700!important}\n#fractal-filter-chips{display:flex!important;flex-wrap:nowrap!important;overflow-x:auto!important;gap:3px!important;padding:2px 0!important;scrollbar-width:none!important}\n#fractal-filter-chips::-webkit-scrollbar{display:none}\n#fractal-filter-chips .btn{padding:3px 10px!important;font-size:.78rem!important;white-space:nowrap!important;flex-shrink:0!important}\n#ai-search-input{border-radius:4px!important;padding:8px 14px!important;background:#0a0e17!important;border:1px solid #1e2a3a!important;font-family:'JetBrains Mono',monospace!important;font-size:.88rem!important;color:var(--accent)!important}\n#ai-search-input::placeholder{color:#3a4555!important}\n#ai-search-input:focus{border-color:var(--accent)!important;box-shadow:0 0 0 1px var(--accent)!important}\n#grid-status{background:#0a0e17!important;padding:6px 16px!important;border-radius:0!important;border:none!important;border-top:1px solid #1e2a3a!important;border-bottom:1px solid #1e2a3a!important;font-family:'JetBrains Mono',monospace!important;font-size:.85rem!important}\n#blocked-grid{border-left:3px solid #ff4757!important;margin:4px 0!important}\n#active-grid{border-left:3px solid #00d4aa!important;margin:4px 0!important}\n#all-grid{border-left:3px solid #4d96ff!important;margin:4px 0!important}\n.tabulator{border:none!important;border-radius:0!important;font-size:.85rem!important}\n.tabulator .tabulator-header{background:#0d1117!important;border-bottom:1px solid #1e2a3a!important;min-height:32px!important}\n.tabulator .tabulator-header .tabulator-col{padding:4px 8px!important;border-right:1px solid #1a2030!important;font-size:.82rem!important;font-weight:700!important;text-transform:uppercase!important;letter-spacing:.5px!important;color:#7a8fa6!important}\n.tabulator-row{min-height:34px!important;border-bottom:1px solid #141922!important;font-size:.85rem!important}\n.tabulator-row:nth-child(even){background:rgba(13,17,23,.5)!important}\n.tabulator-row:hover{background:rgba(0,212,170,.05)!important;border-left:2px solid var(--accent)!important}\n.tabulator-cell{padding:4px 8px!important}\n.tabulator-footer{background:#0d1117!important;padding:4px 8px!important;border-top:1px solid #1e2a3a!important}\n.tabulator-footer .tabulator-page.active{background:var(--accent)!important;color:#0a0e17!important}\n.page-header+div+div{height:3px!important;padding:0!important;margin:0!important;border:none!important;overflow:hidden!important}\n.detail-panel{background:#0a0e17!important;border:1px solid #1e2a3a!important;border-radius:6px!important;font-family:'JetBrains Mono',monospace!important}\n@media(max-width:768px){.page-header h1{font-size:.95rem!important}.card-grid{padding:2px 8px!important}.card-grid svg{width:44px!important;height:44px!important}.section{padding:6px 8px!important}#grid-section{padding:4px 8px!important}.tabulator-row{min-height:38px!important}}\n";
    document.head.appendChild(cmdEl);
  ...
  var taskColumns = [
    { title:"ID", field:"id", width:75, headerSort:true,
      formatter:function(c) {
        var v = c.getValue();
        return "<span style='font-family:\"JetBrains Mono\",monospace;font-size:0.82rem;opacity:0.6'>" + v.substring(0,8) + "</span>";
      },
    ...
    { title:"Owner", field:"owner", width:90, headerFilter:"input",
      formatter:function(c) {
        var v = c.getValue();
        return v ? "<span style='color:#00d4aa;font-size:0.88rem'>" + v + "</span>" : "<span style='color:#7a8fa6;font-size:0.88rem'>\u2014</span>";
      }
    },
    ...
    { title:"Age", field:"created", width:55,
      formatter:function(c) {
        ...
        var color = "#3dd68c"; // green = recent
        if (age.indexOf("mo") >= 0) {
          color = "#ff4757"; // red = months old
        } else if (age.indexOf("d") >= 0) {
          var days = parseInt(age);
          if (days > 30) color = "#ff4757";      // red = very old
          else if (days > 7) color = "#f5a623";  // amber = stale
          // else green = fresh
        } else if (age.indexOf("h") >= 0) {
          color = "#3dd68c"; // green = hours old
        }
  ...
  function searchKnowledgeInPanel(query, div) {
    ...
    fetch("/api/v1/plan/search?q=" + encodeURIComponent(query))
      ...
      .then(function(text) {
        div.innerHTML = "<div class='detail-section'><div style='color:#00d4aa;font-weight:600;font-size:0.82rem;margin-bottom:8px'>\uD83D\uDCDA Zettelkasten Knowledge</div><pre style='color:var(--text,#e0e6ed);font-size:0.88rem;white-space:pre-wrap;max-height:250px;overflow-y:auto;margin:0;line-height:1.5'>" + text.substring(0,2000) + "</pre></div>";
      })
      ...
      if (allEl) {
        grids.all = createGrid("#all-grid", allData, {
          ...
          footerElement:
            ...
            "<span style='color:#7a8fa6;font-size:0.82rem'>Keys: 1-4 views \u00b7 Ctrl+K search \u00b7 R refresh</span>" +
            "</div>",
          dataLoaded: function() {
            setTimeout(function() {
